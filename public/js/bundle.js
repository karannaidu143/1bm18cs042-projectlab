...
exports.login = exports.logout = exports.signup = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, passwordConfirm, password) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'signed up succcessfully !');
...
var stripe = Stripe('pk_test_ZTvxx0CHmJ652HjE4a44S6tX0097Y59DyP');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  var passwordConfirmsign = document.getElementById('passwordConfirmsign').value;
  var emailsign = document.getElementById('emailsign').value;
  var passwordsign = document.getElementById('passwordsign').value;
  (0, _login.signup)(name, emailsign, passwordConfirmsign, passwordsign);
});
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // const tourId=e.target.dataset.tourId//e.target is the current clicked element 
  //in tour.pug tour_id gets changed to tourId
