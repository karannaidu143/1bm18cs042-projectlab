// pls note passwords and jwt are not the same , jwt is like a boolean ture statement which+ is only issued when
...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    //  console.log(url);
    await new Email(newUser, url).sendWelcome();// await as sendWelcome  is an async function
